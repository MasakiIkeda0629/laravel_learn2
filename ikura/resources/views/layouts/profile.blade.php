                    ...
                    <div class="">
                        ...
                        <form action="{{ route('index')}}" method="POST">
                            ...
                            <div>
                                ...
                                <input class="contact_name" type="text" maxlength="15" placeholder="Enter your name..." value="{{ old('name') }}"/>
                                @if($errors->has('name'))
                            ...
                            <div>
                                ...
                                <input class="contact_email" type="email" placeholder="name@example.com" value="{{ old('email') }}"/>
                                @if($errors->has('email'))
                            ...
                            <div>
                                ...
                                <input class="contact_number" type="tel" placeholder="(123) 456-7890" value="{{ old('phone') }}"/>
                                @if($errors->has('phone'))
                            ...
                            <div>
                                ...
                                <textarea class="contact_message" type="text" placeholder="Enter your message here..." value="{{ old('body') }}"></textarea>
                                @if($errors->has('body'))
